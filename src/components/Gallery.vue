...
<template>
  <div class="w-full py-24 px-14 sm:px-4">
    <div class="h-full w-full grid grid-flow-dense gap-3 sm:flex sm:flex-col">
      ...
      <div ref="L1" class="col-start-9 col-end-10 place-self-end sm:mt-5 sm:place-self-start dev-red text-heading-3 mb-5 text-custom-Secondary-2">SECTION 01</div>
      ...
      <div ref="L2" class="col-start-9 col-end-10 row-start-5 sm:mt-5 dev-red text-heading-3 place-self-end sm:place-self-start text-custom-Secondary-2 mb-5">SECTION 02</div>
      ...
      <div ref="L3" class="col-start-4 col-end-4 row-start-[18] mb-5 sm:mt-5 dev-red text-heading-3 place-self-end sm:place-self-start text-custom-Secondary-2">SECTION 03</div>
      ...
      <div ref="L4" class="col-start-4 col-end-4 row-start-[26] mb-5 sm:mt-5 dev-red text-heading-3 text-custom-Secondary-2">SECTION 04</div>
