...
<template>
  <div class="w-full h-[26.0625rem] sm:h-[60rem] flex sm:flex-col justify-between items-center bg-custom-Secondary-0 border-t border-custom-Primary-1">
    <div class="text-display-1 -ml-80 sm:ml-0 text-custom-Primary-1 mb-24">Story</div>
    ...
    <div class="text-display-1 -mr-80 sm:mr-0 text-custom-Primary-1 mb-24">Story</div>
  </div>
</template>
