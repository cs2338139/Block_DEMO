...
<template>
  <div class="absolute dev-red top-[7.6875rem] left-[-2.5625rem] h-[57.1875rem] w-[99.625rem]">
    <fakeImage class="absolute top-[8.5rem] left-[24.25rem] w-[46.625rem] h-[32.4375rem] z-0" />
    <fakeImage class="absolute top-[0rem] left-[56.8125rem] w-[31.4375rem] h-[26.0625rem] -z-20" />
    <div class="absolute top-0 left-0 text-display-0 text-custom-Primary-0 -z-10">1976--Mazda</div>
    <div class="absolute top-[17rem] left-0 text-display-0 text-custom-Primary-0 z-0">RX7s</div>
